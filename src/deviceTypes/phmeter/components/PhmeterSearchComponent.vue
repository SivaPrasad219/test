            ...
            <template v-if="isTimeRelated">
              ...
              >
                <a-select
                  ...
                  class="custom-input"
                  @change="handleTimeZoneChange(selectedTimeZone)"
                >
                  <a-select-option
                    v-for="site in sites"
                    :key="site.timezone"
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const selectedTimeZone: any = ref();
    ...
    const handleSelectChange = (value: any) => {
      ...
      if (timeRelatedTitles.includes(value)) {
        fetchSites();
      }
      isTimeRelated.value = timeRelatedTitles.includes(
    ...
    onMounted(() => {
      console.log(
        "PropsData to the search Component",
        props.dropdownOptions,
        timeRelatedTitles
      );
    });
